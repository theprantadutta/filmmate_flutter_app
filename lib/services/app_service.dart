...
import '../components/home/download_progress_dialog.dart';
...
class AppService {
  ...
  static Future<void> downloadAndUpdate(
    ...
    Dio dio = Dio();
    String appName = 'filmmate.apk';
    String downloadUrl =
        'https://github.com/theprantadutta/filmmate_flutter_app/releases/download/v$downloadVersion/$appName';
